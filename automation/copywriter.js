...
- طرح رو توصیف نکن؛ خودش تو عکس پیداست. اسم نبر که چی کشیده شده (آدم، لباس، پوشش، کلاه، شیء، حیوان، نماد و …) و نگو «این طرح یه … داره» — تشخیصِ تصویر معمولاً اشتباهه، مخصوصاً برایِ چیزهای فرهنگیِ ایرانی. تنها مرجعِ مطمئن «اسمِ محصول در سایت»ـه؛ اگه لازم شد فقط به همون اشاره کن، بدونِ تفسیر و اضافه.
...
${BRAND_POINTS}
چیزی که رویِ طرح‌ها کشیده شده رو توصیف نکن و از اسمِ محصول چیزی حدس نزن؛ از حس‌وحال و آدمی که بهش میاد بگو.
